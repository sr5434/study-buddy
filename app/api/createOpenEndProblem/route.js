...
export async function POST(req) {
    ...
    if (!reqJSON.studyGuide) {
        prompt = `Write a short answer practice problem for the following topic: ${reqJSON.topic}. The class is: ${reqJSON.course}. The student has solved the following problems: ${reqJSON.problems}. These are their responses to each problem: ${reqJSON.answers}. These are their grades for each problem: ${reqJSON.grades}. They requested a difficulty of ${reqJSON.difficulty}.`
    }
    else {
