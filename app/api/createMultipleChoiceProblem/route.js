...
export async function POST(req) {
    ...
    if (!reqJSON.studyGuide) {
        prompt = `Write a multiple practice problem for the following topic: ${reqJSON.topic}. The class is: ${reqJSON.course}. The student has solved the following problems: ${reqJSON.problems}. These are the user's answers: ${reqJSON.answers}. These are the solutions: ${reqJSON.solutions}. They requested a difficulty of ${reqJSON.difficulty}.`
    }
    else {
